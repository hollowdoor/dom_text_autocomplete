...
function getElement(element, context){
    ...
    if(isElement$2(element)) { return element; }

    if(!!element && typeof element === 'object'){
        if(isElement$2(element.element)){
            return element.element;
        }else if(isElement$2(element[0])){
            return element[0];
        }
    }
...
var DOMTextAutocomplete = function DOMTextAutocomplete(input, ref){
    ...
    var arrowSelect$$1 = ref.arrowSelect; if ( arrowSelect$$1 === void 0 ) { arrowSelect$$1 = null; }
    ...
    this.arrowSelect = !!arrowSelect$$1
    ? arrowSelect$$1
    : arrowSelect({
        selectID: selected
    });
